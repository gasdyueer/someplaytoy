...
manga_dirpage = 'http://www.92mh.com/manhua/382/'
headers = {
...
def main():
    ...
    links = content_soup.find_all('a', href=re.compile(r'http://www.92mh.com/manhua/382/\d+.html'))
